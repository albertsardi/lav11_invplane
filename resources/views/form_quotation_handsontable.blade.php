...
<!-- use handontable -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-handsontable/0.10.2/jquery.handsontable.full.min.js" integrity="sha512-jOCHlFTuRXq5ly9DJosOH9yPQLJtpM732faHmQatOB5ftlAX7Paf78q4FKdaUjLWldmsDLwMaOUkSXKNuy7Fbw==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
...
<div id="headerbar">
    <h1 class="headerbar-title">Form [use handsontable] Quote #{{$data->TransNo ??''}}</h1>
...
<div id="content">
	...
	//]]>
        ...
        <p>[table]-using hansontable</p>
        <div class="row">
            <p><div id="grid" style="height:200px;"></div></p>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var data = [
            ["", "Maserati123", "77Mazda123", "Mercedes", "Mini", "Mitsubishi"],
            ["2019", 0, 2941, 4303, 354, 5814],
            ["2010", 5, 2905, 2867, 412, 5284],
            ["2011", 4, 2517, 4822, 552, 6127],
            ["2012", 2, 2422, 5399, 776, 4151]
        ];
        data = [
            ["420","Pk Envio","pack",45,"7000.00",315000],
            ["436","Pk surya 12","pack",1,"45000.00",45000]
        ];
        var config = {
            data: data,
            minRows: 5,
            ...
            colHeaders: true,
            contextMenu: true,
            colWidths: [100, 200, 100, 50,100,150],
            colHeaders: ['Product Code','Product Name','Unit','Qty','Price','Amount'],
            afterChange:function (change, source) {
                if( arguments[1] != "loadData" ) {
                    ...
                    qty = this.getDataAtCell(row,3,0);//console.log('qty',qty);
                    price = this.getDataAtCell(row,4,0);//console.log('price',price);
                    //if (price=='null') price=0;
                    var amount = qty * price;
                    this.setDataAtCell( row, 5, amount );

                }
            }

        }
        $("#grid").handsontable(config);
